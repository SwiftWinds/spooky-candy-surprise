...
//            // Serial.println(String("Encoder: ") + currPos);
        ...
        while (lastButton != currentButton) {
            ...
            wasInLoop = true;
            delay(BUTTON_DELAY);
            Serial.println(String("after delay with lastButton: ") + lastButton + ", currentButton: " + currentButton);
            lastButton = currentButton;
            currentButton = digitalRead(BUTTON_PIN);
        }
        if (wasInLoop) {
            Serial.println(String("exited loop with lastButton: ") + lastButton + ", currentButton: " + currentButton);
            origPos = currPos;
